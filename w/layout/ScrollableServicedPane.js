...
],function(declare,Scrollable,_SSP,_FormMixin,_ModelMixin,_PageKeysMixin,_PagedMixin,Subscribable){
return declare("dlagua.w.layout.ScrollableServicedPane",[_SSP, Scrollable, _FormMixin, _ModelMixin, _PageKeysMixin, _PagedMixin, Subscribable],{
	nativeScroll:false,
	noCover:false
});
